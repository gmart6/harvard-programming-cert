...
//        return new StringNode(str.ch, copyRest);
        ...
        StringNode newBoi = new StringNode(trav.ch, null);
        StringNode newString = newBoi;
        trav = trav.next;

        while (trav != null) {
            StringNode newBoi2 = new StringNode(trav.ch, null);
            trail.next = newBoi2;
            trail = trail.next;
            trav = trav.next;
        }
...
//        return str;
        ...
        return str.next = insertBefore(str.next, newChar, beforeChar);
...
//        StringNode str2 = StringNode.convert(s);
        StringNode str1 = StringNode.convert("abcd");
//        StringNode str2 = StringNode.convert("abc");
